# Conveyor Belt Automation Simulation
...
- Create conveyor belt model in Blender
- Create conveyor rollers
- Create transport box models
- Implement Start and Stop controls
- Add speed control slider
- Simulate box movement
- Import Blender .glb models into Python
- Develop basic UI using Ursina
- Test conveyor workflow
...
To develop a simple conveyor belt automation simulation by integrating Blender-created 3D models with Python controls and basic object movement functionality.